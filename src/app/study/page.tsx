...
export default function StudyPage() {
    ...
    return (
        <div className="flex bg-[#121212] min-h-screen text-white pl-20 lg:pl-64 pt-16">
            {/* 왼쪽 사이드바: 글 목록 */}
            <div className="w-64 border-r border-[#333] bg-[#1E1E1E] flex flex-col h-[calc(100vh-4rem)]">
                <div className="p-4 border-b border-[#333] flex items-center gap-2">
                    <BookOpen size={20} className="text-[#F7D047]" />
                    <h2 className="font-bold text-lg">주식 스터디 목록</h2>
                </div>
