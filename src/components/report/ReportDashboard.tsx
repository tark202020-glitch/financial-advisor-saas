                                ...
                                <div className="relative p-6 pl-7">
                                    <div className="flex items-center gap-2 mb-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[10px] text-indigo-300/50">{queryStartDate} ~ {queryEndDate}</p>
                                        </div>
                                    </div>
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                        {cards.map(card => (
                                            <div
                                                key={card.key}
                                                className="bg-[#1a1a2e]/60 border border-[#333] rounded-xl p-4 cursor-pointer hover:border-indigo-500/30 transition-colors"
                                            ...
                                            >
                                                ...
                                                {expandedCard === card.key && (
                                                    <div className="mt-3 pt-3 border-t border-[#444]">
                                                        <p className="text-[11px] text-indigo-400 font-semibold mb-1">📐 계산식</p>
