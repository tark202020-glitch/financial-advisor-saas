## [Alpha V1.297] - 2026-03-09 23:52:47

### 🐛 Bug Fix
- **Summary**: 배치 API 내부 KIS API rate limit 초과 문제 해결
- **Detail**:
  - 국내주식: 5개 동시 → 3개씩 병렬 + 500ms 딜레이
  - 해외주식: 5개 동시 → 1개씩 순차 + 350ms 딜레이
  - 실패 종목 자동 재시도: 1.5초 대기 후 1건씩 500ms 간격 재시도
  - 이전 설정(5개씩/200ms)이 초당 20건 제한 초과 → 수정으로 초당 ~3건으로 안전 마진 확보
- **Build Time**: 2026-03-09 23:52:47
