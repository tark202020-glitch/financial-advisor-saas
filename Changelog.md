## [Alpha V1.176] - 2026-02-13 16:30:00

### 🎨 UI: 대시보드 지수 시인성 개선 및 정리
- **Summary**: 주요 지표 폰트 크기 확대 및 마켓트렌드 섹션 삭제
- **Detail**:
  - **폰트 강조**: KOSDAQ, 미국지수 등락률(%) 및 환율/금리 수치 폰트 크기 확대 (가독성 개선)
  - **섹션 정리**: "마켓트렌드 (투자자별 순매수)" 테이블 삭제 (KOSPI 메인 블록에 통합됨)
  - **금**: 금 가격(USD/oz) 표시 확인
- **Build Time**: 2026-02-13 16:30:00
