## [Alpha V1.212] - 2026-02-14 21:50:00

### 🎓 Feature: Onboarding Tutorial (Jubot Guide)
- **Summary**: 신규 사용자를 위한 주봇 튜토리얼 가이드 추가
- **Detail**:
  - `TutorialContext` 및 `JubotGuideOverlay` 구현.
  - 대시보드 -> 포트폴리오 -> 인사이트 순서로 이어지는 단계별 가이드 제공.
  - 주봇 캐릭터가 각 페이지의 핵심 기능과 메모 활용법을 대화형으로 안내.
- **Build Time**: 2026-02-14 21:50:00
